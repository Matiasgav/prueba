...
\begin{longtable}{@{}>{\RaggedRight\arraybackslash}p{\dimexpr 0.0841\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1258\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1215\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1258\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1581\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1366\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1121\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1310\linewidth-2\tabcolsep\relax}@{}}
\toprule
...
\begin{figure}[htbp]\centering
\fbox{\includegraphics[width=0.98\linewidth]{assets/esq-acc.pdf}}
...
\setlength{\emergencystretch}{4em}
\hyphenpenalty=50 \exhyphenpenalty=50
\begin{longtable}{@{}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1419\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.2976\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.2579\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.2976\linewidth-2\tabcolsep\relax}@{}}
\toprule
