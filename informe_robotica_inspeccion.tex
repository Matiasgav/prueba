...
\begin{longtable}{@{}>{\RaggedRight\arraybackslash}p{\dimexpr 0.0877\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1312\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1267\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1072\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1462\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1424\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1169\linewidth-2\tabcolsep\relax}>{\RaggedRight\arraybackslash}p{\dimexpr 0.1366\linewidth-2\tabcolsep\relax}@{}}
\toprule
\scriptsize\textbf{Candidato} & \scriptsize\textbf{Activo} & \scriptsize\textbf{\{\{t:madurez-m} & \scriptsize\textbf{Madurez\}\} hipotética} & \scriptsize\textbf{Evidencia económica} & \scriptsize\textbf{\{\{t:incumbente} & \scriptsize\textbf{Incumbente\}\} conocido} & \scriptsize\textbf{Reutilización de plataforma} \\
\midrule
\endfirsthead
\toprule
\scriptsize\textbf{Candidato} & \scriptsize\textbf{Activo} & \scriptsize\textbf{\{\{t:madurez-m} & \scriptsize\textbf{Madurez\}\} hipotética} & \scriptsize\textbf{Evidencia económica} & \scriptsize\textbf{\{\{t:incumbente} & \scriptsize\textbf{Incumbente\}\} conocido} & \scriptsize\textbf{Reutilización de plataforma} \\
...
\bottomrule
\endfoot
\textbf{A} & \{\{t:ipb & Bus isofásico (IPB)\}\} & \badge{lblue}{ink}{M3} \badge{lblue}{ink}{M4} & Publicada, nivel A & Servicios de inspección especializados & Alta &  \\
\textbf{B} & \{\{t:hrsg & HRSG\}\}: headers y tubos & \badge{lblue}{ink}{M4} & Parcial; parte declarada por fabricante & TesTex (IAT, Claw) & Media-alta &  \\
...
\end{tarjeta}
\begin{tarjeta}{7. Recuperación y \{\{t:fme}{FME\}\}}
...
\end{tarjeta}
\begin{tarjeta}{19 \textperiodcentered{} Precio y \{\{t:ticket}{ticket\}\}}
...
\end{tarjeta}
\begin{tarjeta}{22 \textperiodcentered{} \{\{t:go-nogo}{Decisión de avance\}\}}
